...
public class Board50sActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_board20s);
        ...
        new Thread(){
            public void run(){
                try{
                    ...
                    ArrayList<String> keyword50 = new ArrayList<String>();
                    int i;
                    for(i = 100; i<120; i++ ){
                        keyword50.add(items.get(i).text());
                    }

                    int ran = (int)(Math.random()*20);
                    keyword = keyword50.get(ran);
