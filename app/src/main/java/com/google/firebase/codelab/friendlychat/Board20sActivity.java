...
public class Board20sActivity extends AppCompatActivity {
        ...
        new Thread(){
            public void run(){
                try{
                    ...
                    ArrayList<String> keyword20 = new ArrayList<String>();
                    int i;
                    for(i = 40; i<60; i++ ){
                        keyword20.add(items.get(i).text());
                    }

                    int ran = (int)(Math.random()*20);
                    keyword = keyword20.get(ran);
